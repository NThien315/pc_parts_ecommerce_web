...
namespace PCPartsWeb.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string Email, string Password, bool? RememberMe)
        {
            ...
            string hash = PCPartsWeb.Helpers.SecurityHelper.HashPassword(Password);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Register(PCPartsWeb.Models.User user, string Password, string ConfirmPassword)
        {
            ...
            user.PasswordHash = PCPartsWeb.Helpers.SecurityHelper.HashPassword(Password);
            user.Role = "User";
        ...
        public ActionResult ChangePassword(string CurrentPassword, string NewPassword, string ConfirmPassword)
        {
            ...
            string currentHash = PCPartsWeb.Helpers.SecurityHelper.HashPassword(CurrentPassword);
            ...
            user.PasswordHash = PCPartsWeb.Helpers.SecurityHelper.HashPassword(NewPassword);
            db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult UserProfile(PCPartsWeb.Models.User updatedUser)
        {
            // Kiểm tra đăng nhập
            var currentUser = Session["User"] as PCPartsWeb.Models.User;
