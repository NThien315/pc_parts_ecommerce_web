    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult ResetPassword(int id)
        {
            ...
            if (user != null)
            {
                ...
                user.PasswordHash = PCPartsWeb.Helpers.SecurityHelper.HashPassword(defaultPass);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult UserCreate(PCPartsWeb.Models.User user)
        {
            if (ModelState.IsValid)
            {
                ...
                user.PasswordHash = PCPartsWeb.Helpers.SecurityHelper.HashPassword(user.PasswordHash);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult UserEdit(PCPartsWeb.Models.User user)
        {
            if (ModelState.IsValid)
            {
