namespace PCPartsWeb.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PCPartsWeb.Models.SaleDbContext>
    {
        ...
        protected override void Seed(PCPartsWeb.Models.SaleDbContext context)
        {
            // CATEGORY
